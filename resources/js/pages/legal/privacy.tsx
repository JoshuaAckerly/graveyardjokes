  ...
  return (
    <div title="Privacy Policy">
      <div className="mx-auto max-w-4xl space-y-4 bg-gray-900 p-6 text-white">
        ...
        <p>
          <strong>Visitor Tracking:</strong> We automatically track basic visitor
          information on every page visit using custom analytics. This includes
          your IP address, which we use with geolocation services (IPInfo.io) to
          determine your approximate location.
        </p>
        <p>
          <strong>Google Analytics:</strong> We use Google Analytics to understand
          site usage patterns. Google Analytics may set cookies and collect data
          according to Google's privacy policy.
        </p>
        <p>
          <strong>Session Cookies:</strong> We use essential session cookies
          (named <code>graveyardjokes_session</code>) for basic site functionality
          and CSRF protection. These are necessary for the site to function properly.
        </p>
        ...
        <p>
          ...
          except as required by law or as described in this policy. We use the following
          third-party services:
        </p>
        <ul className="list-inside list-disc">
          <li><strong>Google Analytics:</strong> For site usage analytics</li>
          <li><strong>IPInfo.io:</strong> For geolocation services</li>
          <li><strong>Zoho Mail:</strong> For email services and notifications</li>
        </ul>
        <p>
          Visitor data is cached temporarily to improve performance and reduce API calls.
          Contact form submissions are stored securely and used only to respond to inquiries.
        </p>
