        ...
        <div title="Cookie Policy">
            <div className="max-w-4xl p-6 mx-auto space-y-4 text-white bg-gray-900">
                ...
                <ul className="list-disc list-inside">
                    <li>
                        <strong>Session Cookies</strong> – These are essential for the operation of our website. We use a session cookie (named based on our app name, e.g., <code>graveyard_jokes_studio_session</code>) to manage your login state and other session data. Session data is stored securely in our database and is not accessible to third parties.
                    </li>
                    <li>
                        <strong>Security Settings</strong> – Our session cookies are set with the following technical attributes:
                ...
                <p>
                    You can disable cookies via your browser settings. Disabling essential session cookies may prevent you from logging in or using certain features. By continuing to use this website, you consent to our use of cookies as described above.
                </p>
            </div>
        </div>
    );
