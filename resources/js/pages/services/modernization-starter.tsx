...
export default function ModernizationStarterPackage() {
    ...
    return (
        <>
            <Head>
                <title>Website Modernization - Starter Package - $249 | Graveyard Jokes Studios</title>
                <meta
                    name="description"
                ...
                <meta name="twitter:title" content="Website Modernization - Starter Package - $249 | Graveyard Jokes Studios" />
                <meta
                    ...
                    >
                        ...
                        <div className="rounded-lg bg-black/50 p-6">
                            ...
                            <div className="min-h-[50px]">
                                <PackagePaymentGate amount={249} item="Website Modernization - Starter" packageSlug="modernization-starter" />
                            </div>
                        </div>
                    </motion.div>
                </div>
