                    ...
                    <div className="mt-12 space-y-8 pb-8">
                        <section>
                            ...
                            <p className="text-white/70">
                                ...
                                already have a developer or want to thoroughly plan their visual direction before committing to full development.
                            </p>
                        </section>
                        <section>
                            ...
                            <p className="text-white/70">
                                ...
                                Users form opinions about websites almost instantly, and those impressions directly influence whether they stay,
                                explore, and ultimately convert into customers or fans. Our design process is rooted in user experience principles,
                                ensuring layouts are intuitive, calls to action are clear, and visual hierarchy guides visitors toward the outcomes
                                you care about.
                            </p>
                        </section>
                        <section>
                            ...
                            <p className="text-white/70">
                                ...
                                businesses across the United States. We understand that a musician's website needs to feel different from a corporate
                                firm — it should capture energy, personality, and genre. We translate your artistic identity into a visual language
                                that resonates with your audience and sets you apart from every other band or artist in your space.
                            </p>
                        </section>
                        <section>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <p className="text-white/70">
                                        All designs are delivered as Figma files, which you can share with any developer or keep as a living reference
                                        for your brand going forward. Export assets in any format you need.
                                    </p>
                                </div>
                                <div>
                                    <p className="font-semibold text-white">What if I need more than five pages designed?</p>
                                    <p className="text-white/70">
                                        If you need more pages, we recommend upgrading to the Design Professional package, which includes a complete
                                        UI design system, component library, and four rounds of revisions.
                                    </p>
                                </div>
                                <div>
                                    <p className="font-semibold text-white">Does this package include development?</p>
                                    <p className="text-white/70">
                                        No, this is a design-only package covering wireframes and mockups. If you need development as well, take a
                                        look at our Web Development Starter, Professional, or Premium packages.
                                    </p>
                                </div>
                            </div>
                        </section>
