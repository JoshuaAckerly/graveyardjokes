    ...
    return (
        <MainLayout>
            <>
                ...
                <div className="relative z-0 max-w-full space-y-10 overflow-hidden bg-[#3E403D] text-center">
                    ...
                    <motion.button
                        ...
                        className="relative z-20 flex px-8 py-6 mx-auto text-sm font-semibold text-white transition duration-300 ease-in-out shadow-md bg-green-400 hover:bg-green-900 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2 sm:px-12 sm:py-6 sm:text-lg"
