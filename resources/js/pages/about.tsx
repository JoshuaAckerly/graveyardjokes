          ...
          <div className="relative flex flex-col items-center justify-center px-4">
            ...
            >
              <p className="leading-relaxed">
                ...
                , a passionate web developer and designer. I thrive at the
                intersection of technology and creativity, using{" "}
                <span className="font-semibold text-[var(--primary)]">
                  Laravel, React, and Tailwind CSS
                </span>{" "}
                to build functional, elegant, and expressive websites. This
                portfolio is more than a resume — it’s a glimpse into a
                developer who builds with purpose.
              </p>
            </motion.div>
          </div>
            ...
            <div className="m-8 mx-auto grid max-w-4xl grid-cols-1 gap-6 border-2 border-[var(--accent)] bg-[var(--card)] p-8 shadow-md sm:grid-cols-2">
              {skills.map((skill) => (
                <motion.div
                  ...
                  transition={{ duration: 0.6 }}
                >
                  <p className="w-24 flex-shrink-0 p-2 text-left font-medium text-white">
                    {skill.name}
                  </p>
          ...
          <div className="mt-10 flex flex-col items-center px-4 pb-20">
            ...
            >
              <p className="mb-4 leading-relaxed">
                ...
                — evolved into a brand focused on creative web experiences and
                expressive design.
              </p>
              <p className="mb-4 leading-relaxed">
                Long nights of learning and experimentation shaped it into a
                studio where humor meets function. From interfaces to full-stack
                applications,{" "}
                <span className="font-semibold text-[--primary]">
              ...
              <p className="leading-relaxed">
                Today, it's a playground for merging tech with style, function
                with fun.
              </p>
            </motion.div>
          </div>
