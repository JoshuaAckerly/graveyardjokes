      ...
      <div className="fixed top-6 right-6 z-100">
        ...
        >
          <div className="space-y-2">
            <span
              className={`block h-1 w-8 bg-[var(--primary)] transition-transform ${isOpen ? "translate-y-3 rotate-45" : ""}`}
            />
            <span
              className={`block h-1 w-8 bg-[var(--primary)] transition-opacity ${isOpen ? "opacity-0" : "opacity-100"}`}
            />
            <span
              className={`block h-1 w-8 bg-[var(--primary)] transition-transform ${isOpen ? "-translate-y-3 -rotate-45" : ""}`}
            />
